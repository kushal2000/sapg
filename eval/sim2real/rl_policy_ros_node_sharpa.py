...
class RLPolicyNode:
    ...
    def _initialize_relative_object_pose_logic(
        ...
        from misc.human_demo.visualize_demo import compute_current_T_R_P
        ...
        # Filter the poses
        from misc.human_demo.visualize_demo import filter_poses
        ...
        if MODE == "IK":
            from misc.human_demo.visualize_demo import compute_new_q_arm
            q_arm = q[:7].copy()
            ...
            from misc.human_demo.visualize_demo_trajopt import solve_trajopt, interpolate_traj
            T_R_W = np.linalg.inv(T_W_R)
